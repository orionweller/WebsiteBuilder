...
- Language model pre-training (analysis and modeling). On the analysis side, studying [why LMs act they way they do](https://arxiv.org/abs/2403.12958) and using [pre-training information to help LM generation](https://arxiv.org/abs/2305.13252). On the modeling side improving encoder pre-training with [ModernBERT](https://arxiv.org/abs/2412.13663), comparing architecture differences with [Ettin](https://arxiv.org/abs/2507.11412), and improving multilingual models with [mmBERT](https://github.com/JHU-CLSP/mmBERT).
...
For Fall 2025 I am currently interning at the FAIR language team at Meta's Superintelligence Lab with [Xilun Chen](https://xilunchen.com/) and [Scott Yih](https://scottyih.org/). In the past, I've been lucky to intern from amazing mentors at Google Deepmind, Samaya AI, AI2, and Apple.
